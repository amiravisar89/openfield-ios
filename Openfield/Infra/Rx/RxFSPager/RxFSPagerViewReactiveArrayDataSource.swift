...
class _RxFSPagerViewReactiveArrayDataSource: NSObject, FSPagerViewDataSource {
    func _numberOfItems(in _: FSPagerView) -> Int {
        return 0
    }
    ...
    func _pagerView(_: FSPagerView, cellForItemAt _: Int) -> FSPagerViewCell {
        rxAbstractMethod()
    }
...
//        precondition(indexPath == 0)
    ...
    // data source
    override func _numberOfItems(in _: FSPagerView) -> Int {
